...
static void help(const char* program_name) {
    ...
    fprintf(stderr, "usage: %s [config-file] [args...]\n", program_name);
    fprintf(stderr, "\n");
...
static bool clean_config_dir(const char* config_root, bool is_out_of_source) {
    ...
    remove_if_exists(nob_temp_sprintf("%s/laye", config_root));
    remove_if_exists(nob_temp_sprintf("%s/laye.exe", config_root));

    remove_if_exists(nob_temp_sprintf("%s/layec", config_root));
    remove_if_exists(nob_temp_sprintf("%s/layec.exe", config_root));

    remove_if_exists(nob_temp_sprintf("%s/ccly", config_root));
    remove_if_exists(nob_temp_sprintf("%s/ccly.exe", config_root));
...
int main(int argc, char** argv) {
    ...
    Nob_String_View config_name = get_file_name_without_extension(nob_sv_from_cstr(config_file));
